import { getEmpleados, borrar, getOne, updEmp } from "./API.js";
...
(function(){
    ...
    async function showEmpleados(){
        ...
        categ.forEach(emp => {
            const {_id,nombre, edad, email, documento } = emp;
    ...
    const {_id, nombre, edad, documento, email} = await getOne(idUpdate)

    console.log(_id, nombre, edad, documento, email);

    document.querySelector('#updId').value = _id;
    document.querySelector('#nombreUpd').value = nombre;
    document.querySelector('#edadUpd').value = edad;
    document.querySelector('#emailUpd').value = email;
    document.querySelector('#documentoUpd').value = documento;
    }
...
async function actualizarDatos() {
  ...
  const edad = document.querySelector('#edadUpd').value;
  const documento = document.querySelector('#documentoUpd').value;
  const email = document.querySelector('#emailUpd').value; 
